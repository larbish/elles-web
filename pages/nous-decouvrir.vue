<template>
  <section>
    ...
    <div class="container text-black">
      ...
      <div class="md:grid md:grid-cols-3 mb-20 md:mb-40">
        <div class="md:col-span-2 md:mr-10">
          <div class="flex items-center mb-10 md:mb-20 w-full">
            <h2 class="pr-5">UN CONSTAT</h2>
        ...
        <div class="hidden md:block md:col-span-1">
          <nuxt-img class="md:w-full" src="/violoncelle.png" alt="Violoncelle"></nuxt-img>
        </div>
      </div>
      <div class="md:grid md:grid-cols-3 mb-20 md:mb-40">
        <div class="hidden md:block md:col-span-1">
          <nuxt-img class="md:w-full" src="/pauline_viardot_discover.png" alt="Violoncelle"></nuxt-img>
        </div>
        <div class="md:col-span-2 md:ml-10">
          <div class="flex items-center mb-10 md:mb-20 w-full">
            <div class="h-1 bg-black flex-1"></div>
            <h2 class="text-right pl-5">LE PROJET</h2>
          </div>
          <div class="text-justify">
            <p class="mb-10">
            ...
            <div class="-ml-10 py-5 mt-10 bg-black">
              <p class="ml-10 text-white">Le Festival Un Temps pour Elles</p>
              <p class="ml-10 text-white">Une chaîne vidéo, La Boîte à Pépites</p>
              <p class="ml-10 text-white">Un label de disque, Elles Records (lancement en février 2022)</p>
            </div>
          </div>
        </div>
      </div>
      <div class="mb-20 md:mb-40">
        <div class="flex items-center mb-10 md:mb-20 w-full">
          <h2 class="pr-5">L'ÉQUIPE</h2>
          <div class="h-1 bg-black flex-1"></div>
        </div>
        <div class="md:grid md:grid-cols-12 mb-10 md:mb-20">
          <div class="text-center md:text-left md:col-span-5">
            ...
            <div class="mb-5 md:mb-10">
              <p>Mireille Faure</p>
              <p>Ingénieure du Son</p>
            </div>
            <div class="mb-5 md:mb-0">
              <p>Casilda Desazars, Lorène Gaydon</p>
              <p>Dessinatrices</p>
            </div>
          </div>
          <div class="hidden md:block md:col-span-2">
            <nuxt-img class="m-auto" src="/piano_discover.png" alt="Piano"></nuxt-img>
          </div>
          <div class="md:col-span-5">
            <div class="h-full flex flex-col justify-between">
              <div class="text-center md:text-right mb-5 md:mb-10">
                <p>Marielle COHEN & Jérémie PEREZ</p>
      ...
      <div class="md:grid md:grid-cols-3 mb-10 md:mb-20 xl:-mb-40">
        <div class="md:col-span-2 md:mr-10">
          <div class="flex items-center mb-10 md:mb-20 w-full">
            <h2 class="pr-5">LE COLLECTIF ARTISTIQUE DE RECHERCHE</h2>
            <div class="h-1 bg-black flex-1"></div>
          </div>
          <div class="text-justify">
            <p class="mb-10 text-3xl">
              Un livre peut être lu, un tableau regardé mais la musique si elle n’est pas jouée ou enregistrée, n’existe
              pas.
            </p>
            <p class="mb-5">
              Le coeur battant des travaux de Elles est la mise en place d'un dispositif de recherche de manuscrits et
              de leur lecture musicale systématique par un collectif de musiciens prestigieux.
            </p>
            <p>
              Ces musiciens cherchent les manuscrits, les déchiffrent ensemble et évaluent la qualité des oeuvres. Ce
              sont ces oeuvres nouvellement (re)découvertes qui servent de matière aux actions de médiation et aux
              enregistrements à venir ainsi qu’à la programmation du Festival Un Temps pour Elles.
            </p>
          </div>
        </div>
        <div class="hidden md:block md:col-span-1">
          <nuxt-img class="md:w-full xl:h-3/4" src="/partitions.png" alt="Violoncelle"></nuxt-img>
        </div>
      </div>
      <nuxt-img
        class="hidden md:block m-auto mb-10 md:mb-20"
        src="/banner_bottom_discover.png"
        alt="Les Artistes du collectif"
      ></nuxt-img>
      <nuxt-img
        class="block md:hidden m-auto mb-10 md:mb-20"
        src="/banner_bottom_mobile_discover.png"
        alt="Les Artistes du collectif mobile"
      ></nuxt-img>
      <div class="mb-5 md:mb-10">
        <div class="flex items-center md:mb-5 w-full">
      ...
      <div class="mb-20 md:mb-40">
        <div class="flex items-center md:mb-5 w-full">
          <h2 class="pr-5">NOS SOUTIENS</h2>
          <div class="h-1 bg-black flex-1"></div>
        </div>
        <div class="flex flex-wrap justify-around lg:justify-between">
          <nuxt-img class="" src="/discover_logo6.png" alt="Logo DRAC"></nuxt-img>
          <nuxt-img class="" src="/discover_logo7.png" alt="Logo centre national de la musique"></nuxt-img>
          <nuxt-img class="" src="/discover_logo8.png" alt="Logo Val d'Oise"></nuxt-img>
          <nuxt-img class="" src="/discover_logo9.png" alt="Logo Région Île de France"></nuxt-img>
        </div>
        <div class="flex flex-wrap justify-around lg:justify-between">
          <nuxt-img class="" src="/discover_logo10.png" alt="Logo ville de Mery sur Oise"></nuxt-img>
          <nuxt-img class="" src="/discover_logo11.png" alt="Logo ville de Taverny"></nuxt-img>
          <nuxt-img class="" src="/discover_logo12.png" alt="Logo Lazard frères gestion"></nuxt-img>
          <nuxt-img class="" src="/discover_logo13.png" alt="Logo Banque Populaire"></nuxt-img>
        </div>
      </div>
    </div>
  </section>
